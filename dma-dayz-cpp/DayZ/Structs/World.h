...
namespace DayZ {
	...
	public:
		...
		World() {
			this->registerOffset(0xF50, &NearEntityTableCount, sizeof(int32_t));
			this->registerOffset(0x1098, &FarEntityTableCount, sizeof(int32_t));
			this->registerOffset(0x2018, &SlowEntityCountAlloc, sizeof(int32_t));
			this->registerOffset(0x1F90, &SlowEntityValidCount, sizeof(int32_t));
			this->registerOffset(0x2068, &ItemTableCountAlloc, sizeof(int32_t));
			this->registerOffset(0x2070, &ItemTableCount, sizeof(int32_t));
